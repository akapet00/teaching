...
syms = pammod(d,4);  % apply PAM4 modulation
...
% sample rate is is 200 thousands samples per unit time.
SNR = 30;
maxOffset = 5;
fc = 902e6;
fs = 200e3;
...
unknownFrames = L04E04_modClassGetNNFrames(rx);

% classify unknown frames
[prediction,score] = classify(trainedNet,unknownFrames);
...
L04E04_modClassPlotScores(score,modulationTypes)
